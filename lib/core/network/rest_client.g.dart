...
class _RestClient implements RestClient {
  ...
  Future<ApiResponseRecommendationListResponse> getMyRecommendations({
    ...
    final queryParameters = <String, dynamic>{
      r'suitabilityLevel': suitabilityLevel,
      r'page': page,
      r'size': size,
    };
    ...
    final _options = _setStreamType<ApiResponseRecommendationListResponse>(
      Options(method: 'GET', headers: _headers, extra: _extra)
          .compose(
            _dio.options,
            '/api/v1/me/job-recommendations',
    ...
    late ApiResponseRecommendationListResponse _value;
    try {
      _value = ApiResponseRecommendationListResponse.fromJson(_result.data!);
    } on Object catch (e, s) {
